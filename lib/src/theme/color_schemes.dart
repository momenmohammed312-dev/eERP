...
class AppPalettes {
  ...
  static const light = AppColorsExtension(
    ...
    successContainer: Color(0xFFD5E8F0),
    onSuccessContainer: Color(0xFF2E5395),
    warning: Color(0xFFED6C02),
    onWarning: Colors.white,
    warningContainer: Color(0xFFFFECE0),
    onWarningContainer: Color(0xFFED6C02),
    info: Color(0xFF0288D1),
    onInfo: Colors.white,
    infoContainer: Color(0xFFE3F2FD),
    onInfoContainer: Color(0xFF0288D1),
  );
